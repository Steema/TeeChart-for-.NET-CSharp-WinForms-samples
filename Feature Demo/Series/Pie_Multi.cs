...
namespace Steema.TeeChart.Samples
{
	public class Pie_Multi : Samples.BaseForm
	{
		...
		private void pieSeries1_BeforeDrawValues(object sender, Steema.TeeChart.Drawing.Graphics3D g)
		{
			this.tChart1.Chart.ChartRect = new Rectangle(10,10,this.tChart1.Width/2-20, this.tChart1.Height/2-20);
		}

		private void pieSeries2_BeforeDrawValues(object sender, Steema.TeeChart.Drawing.Graphics3D g)
		{
			this.tChart1.Chart.ChartRect = new Rectangle(this.tChart1.Width/2,10,this.tChart1.Width/2-20, this.tChart1.Height/2-20);
		}

		private void pieSeries3_BeforeDrawValues(object sender, Steema.TeeChart.Drawing.Graphics3D g)
		{
