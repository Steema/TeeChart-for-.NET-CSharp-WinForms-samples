...
{
	public class TCommander_Demo : Samples.BaseForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Text = "Commander component is used to manipulate Charts, offering several buttons in a s" +
