...
namespace Steema.TeeChart.Samples
{
    ...
    {
      return (string)Steema.TeeChart.Utils.Registry_GetValue(Steema.TeeChart.Utils.TeeChartKeyName, "DemoPath", @"..\..\");
    ...
    string result = DemoPath();
      ...
      return result;
		...
		{
      Steema.TeeChart.Utils.Registry_SetValue(Steema.TeeChart.Utils.TeeChartKeyName, "DemoPath", path);
		}
	}
}